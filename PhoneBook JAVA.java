        ...
        if (contacts.containsKey(name)) {
            ...
            option: while (true) {
                switch (editOption) {
                    ...
                    default:
                        System.out.println(
                                "Use 'add' to save a new number, 'delete' to remove an existing number or 'cancel' to go back.");
            ...
            if (addNumber) {
                while (true) {
                    ...
                    if (number.matches("^\\+?[0-9 ]{3,25}$")) {
                        ...
                        System.out.println(
                                "Number may contain only '+', spaces and digits. Min length 3, max length 25.");
                    }
                }
            }
